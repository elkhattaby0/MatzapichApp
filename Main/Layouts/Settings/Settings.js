import { View, Text, StyleSheet, StatusBar, Platform, TouchableOpacity, Image, ActivityIndicator, TextInput, Animated } from "react-native";
import { colors } from "../../Assist/Colors";
import { useNavigation } from "@react-navigation/native";
import { useSelector } from "react-redux";
import * as ImagePicker from 'expo-image-picker';
import { useState, useEffect, useRef } from "react";
import ProfileImage from "../../Supabase/ProfileImage";
            ...
            if (!res.cancelled) {
                ...
                if (user[0]?.id) {
                    try {
                        ...
                        if (resp.success) {
                            console.log('Image uploaded successfully:', resp.publicUrl);
                            user[0].Image = resp.publicUrl; // Update user image
                        } else {
                            console.error('Image upload failed:', resp.message);
                        }
                    } catch (error) {
                            ...
                            <View style={{width:"85%", backgroundColor:'',
                                ...
                                </View>
                                {
                                    ...
                                    <TouchableOpacity 
                                        ...
                                        style={{alignItems: 'center', height: 39, width:"10%", justifyContent:"center", backgroundColor:''}}
                                    >
                                        <Image
